...
""" 
    def get_check_completion_prompt(self):  
        return f"""Command: Take the next response of the interviewee to evaluate if this part of the case study is completed. To evaluate if the framework is completed you can use the following criteria:
